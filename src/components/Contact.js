            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p class="text-body-color mb-9 text-base leading-relaxed">
                  We're always here to help you succeed in the digital world. We
                  encourage you to get in touch with us. We value open
                  communication and transparency with our clients, and we're
                  always happy to provide expert advice. Contact us today and
                  discover how OneDigitalExpert can take your business to the
                  next level.
                </p>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">(+91)7304022360</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
