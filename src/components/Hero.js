    ...
    <div>
      <div class="bg-white pb-6 sm:pb-8 lg:pb-12">
        ...
        <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div class="mb-8 flex flex-wrap justify-between md:mb-16">
            <div class="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
              ...
              <p class="max-w-md leading-relaxed text-gray-500 xl:text-lg">
                Welcome to OneDigitalExpert web development services! We
                specialize in building beautiful and effective websites that
                help businesses of all sizes reach their full potential online.
              </p>
            </div>
          ...
          <div class="flex flex-col items-center justify-center gap-9 md:flex-row">
